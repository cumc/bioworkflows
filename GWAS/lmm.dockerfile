...
RUN pip install pandas_plink pybgen scipy

# Download and install PLINK2

RUN wget http://s3.amazonaws.com/plink2-assets/plink2_linux_x86_64_20200923.zip  && \
