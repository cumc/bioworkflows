...
$( document ).ready(function(){
            ...
            var file=variant-annotationDict[$("h1:first").attr("id")];
            $("#toc-level0 a").css("color","#126dce");
            $('a[href="#'+$("h1:first").attr("id")+'"]').hide()
            var docs=variant-annotationArray;
            var docs_map=variant-annotationArrayMap;
            var pos=variant-annotationArray.indexOf(file);
            for (var a=pos;a>=0;a--){
